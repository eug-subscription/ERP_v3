...
export const mockMessages: Message[] = [
    ...
    // Unreplied messages from Phoenix
    {
        id: "7",
        user: PHOENIX_USER,
        text: "Thanks! Can we also get the photos in high-res format?",
        time: "2026-02-18T08:10:00Z",
        isCurrentUser: false,
        status: "delivered",
        attachments: [],
        reactions: [],
    ...
    },
    {
        id: "8",
        user: PHOENIX_USER,
        text: "Also, the client asked for 2 extra shots of the exterior.",
        time: "2026-02-18T08:12:00Z",
        isCurrentUser: false,
        status: "delivered",
        attachments: [],
        reactions: [],
    ...
    },
    {
        id: "9",
        user: PHOENIX_USER,
        text: "Let me know when you can schedule those.",
        time: "2026-02-18T08:13:00Z",
        isCurrentUser: false,
        status: "delivered",
        attachments: [],
        reactions: [],
