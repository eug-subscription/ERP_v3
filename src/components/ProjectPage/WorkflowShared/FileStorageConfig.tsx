        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-right-2 duration-500">
                    ...
                    >
                        <div className="flex items-center justify-between mb-2 px-0.5">
                            <div className="space-y-0.5">
                                <Label className="t-mini font-bold uppercase tracking-wider text-muted-foreground block">Time to Life</Label>
                                <Description className="t-mini block m-0 p-0 text-muted-foreground/60">Days to keep files after completion.</Description>
                            </div>
                            {config.timeToLife === 0 && (
                                <div className="t-mini font-bold px-2 py-0.5 bg-accent/10 text-accent rounded-full border border-accent/20 uppercase tracking-tight animate-in fade-in zoom-in-95 duration-200">
                                    Indefinite
                                </div>
                            )}
                        </div>
                        ...
                        <div className="mt-3 px-1 flex items-start gap-1.5 opacity-60">
                            ...
                            <p className="t-mini leading-tight m-0 p-0 italic">Set to 0 to disable automatic deletion (archived forever).</p>
                        </div>
                    </NumberField>
                </div>
            </section>
            ...
            <div className="bg-warning/5 p-4 mx-[-1rem] border-y border-warning/10 flex gap-4 items-start animate-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="space-y-1">
                    <span className="t-mini font-bold uppercase tracking-widest text-warning/80">Infrastructure Note</span>
