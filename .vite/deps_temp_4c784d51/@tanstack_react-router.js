import {
  require_shim
} from "./chunk-5VSKVNQA.js";
import {
  require_react_dom
} from "./chunk-OAORDXIJ.js";
import {
  require_jsx_runtime
} from "./chunk-B2VBJYSU.js";
import {
  __commonJS,
  __toESM,
  require_react
...
function buildMatchSnapshot({
  ...
  const isGlobalNotFound = matchResult.foundRoute ? matchResult.foundRoute.path !== "/" && matchResult.routeParams["**"] : trimPathRight2(pathname);
  if (isGlobalNotFound) {
    if (notFoundRoute) {
